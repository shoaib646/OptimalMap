...
class RouteNode:
    ...
    def expand_nodes(self, traffic_network):
        nodes = list()
...
# open the route file 
def open_road_network(file):
    tg = TrafficGraph()
    fieldnames = ['Stop_IDs', 'Site Description', 'Site Type', 'Longitude', 'Latitude', 'Neighbours']
    with open(file, newline='') as csvfile:
        ...
        for row in reader:
            ...
            node = Node()
            node.scats_number = int(row['Stop_IDs'])
